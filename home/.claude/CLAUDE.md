...
3. Delegate the PR to the `pr-consistency-review` and `pr-coderules-review` subagents with the PR link (in parallel);
   resolve any `CHANGES REQUESTED` verdict from either before merging.
