...
printf '\033]0;claudew R\007'
printf '\033]1337;SetUserVar=CLAUDEW=%s\007' "$(printf R | base64)"
...
docker compose up -d --build claudew_r
docker compose exec claudew_r claudew "$@"